                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-neon-purple/10 border border-neon-purple/20 mb-6">
                            ...
                            <span className="text-xs font-bold text-neon-purple uppercase tracking-widest">About Me</span>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            {stats.map((stat, idx) => (
                                <div key={idx} className="glass-card p-4 rounded-xl border border-white/5">
                                    <stat.icon className="w-5 h-5 text-neon-purple mb-2" />
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="absolute inset-0 bg-neon-purple/10 rounded-3xl blur-3xl -z-10" />
                        <div className="relative z-10 p-4 md:p-8">
                            <ChatUI />
                            <div className="mt-8 glass-card p-6 rounded-2xl border border-white/10 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 w-24 h-24 bg-neon-purple/10 rounded-full blur-2xl -mr-12 -mt-12" />
